...
export class RestreamAuthService {
  ...
  private readonly refreshToken$ = this.tokensService.getToken('restreamRefreshToken');
  ...
  handleTokenMissingError() {
    ...
    const snackBar = this.snackBar
      .open('Waiting for restream token', 'cancel');
  ...
  getRestreamToken(code: string) {
    return this.http.post(`http://localhost:5001/kirjs-stream-overlay/us-central1/getRestreamToken`, {
